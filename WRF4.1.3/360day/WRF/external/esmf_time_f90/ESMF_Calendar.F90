...
!-srahimi
      INTEGER, PARAMETER :: mday360d(MONTHS_PER_YEAR) &
...
!-srahimi
      ...
      if ( calendartype%caltype  /= ESMF_CAL_360DAY%caltype ) then
         write(6,*) 'Not a valid calendar type for this implementation'
         write(6,*) 'This implementation only allows ESMF_CAL_360DAY'
         write(6,*) 'calender type set to     = ', calendartype%caltype
         write(6,*) '360DAY calendar type is = ', ESMF_CAL_360DAY%caltype
         return
      end if
